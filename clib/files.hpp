...
namespace clib {
    ...
    size_t file_write(const char* filename, const char* data, size_t size) { // TODO test (from fileio.hpp - remote-desktop project)
    ...
    size_t file_read(const char* filename, char* data, size_t size) { // TODO test (from fileio.hpp - remote-desktop project)
        ...
        return (size_t)file.gcount();  // Return the actual number of bytes read
    }

    size_t file_size(const char* filename) { // TODO test (from fileio.hpp - remote-desktop project)
